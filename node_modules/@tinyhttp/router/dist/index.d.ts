 ...
 */
export declare const pushMiddleware: <Req extends unknown = any, Res extends unknown = any>(mw: Middleware[]) => ({ path, handler, method, handlers, type, fullPaths }: MethodHandler<Req, Res> & {
    method?: Method;
